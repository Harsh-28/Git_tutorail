...
const Overview = () => {
  return (
    <div className="self-stretch rounded-t-none rounded-b-xl ml-4 w-full bg-text-white  text-text-100 overflow-y-auto flex flex-col p-5 items-start justify-start z-[0] text-lg">
            <div className="self-stretch flex flex-col items-start justify-start">
              <div className="self-stretch flex flex-col items-start justify-start gap-[24px]">
                <div className="flex flex-col items-start justify-start gap-[16px]">
                  ...
                  <div className="rounded-xl box-border w-[1226px] overflow-hidden flex flex-row items-start justify-start gap-[1px] text-sm border-[1px] border-solid border-system-stroke2">
                    <div className="self-stretch bg-text-white w-[162px] overflow-hidden shrink-0 flex flex-col py-4 px-5 box-border items-start justify-start gap-[16px]">
                      ...
                      <div className="flex flex-row items-center justify-start gap-[10px] text-xl">
                        ...
                        />
                        <b className="relative leading-[140%]">34</b>
                      </div>
                    </div>
                    <img
                    ...
                    <img
                      ...
                      src="/vector-251.svg"
                    />
                    <div className="self-stretch bg-text-white w-[188px] overflow-hidden shrink-0 flex flex-col py-4 pr-[50px] pl-5 box-border items-start justify-start gap-[16px]">
                      <div className="relative leading-[140%] font-semibold">
                        Total Purpose
                      </div>
                      <div className="flex flex-row items-center justify-start gap-[10px] text-xl">
                        ...
                        />
                        <b className="relative leading-[140%]">11</b>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="flex flex-col items-start justify-start gap-[16px]">
                  ...
                  <div className="flex flex-col items-start justify-start gap-[30px]">
                    <div className="w-[1224px] flex flex-row items-start justify-start gap-[30px]">
                      <div
                        className="self-stretch flex-1 rounded-xl bg-system-background overflow-hidden flex flex-col p-[30px] items-center justify-center relative gap-[12px] cursor-pointer text-center border-[1px] border-dashed border-system-stroke2"
                        // onClick={openFrame2}
                      >
                        <div className="flex flex-col items-center justify-start gap-[10px] z-[0]">
                          <div className="rounded-[72px] bg-text-white w-[70px] h-[70px] overflow-hidden shrink-0 flex flex-row p-2.5 box-border items-center justify-center">
                            <img
                      ...
                      <div className="self-stretch flex-1 rounded-xl bg-text-white overflow-hidden flex flex-col p-4 items-start justify-start relative gap-[16px] border-[1px] border-solid border-system-stroke2">
                            ...
                            <div className="flex flex-col items-start justify-start gap-[2px]">
                              ...
                              <div className="flex flex-row items-center justify-start gap-[10px] text-sm">
                                ...
                                <img
                                  ...
                                  src="/vector-333.svg"
                                />
                                <div className="h-[22px] flex flex-row items-center justify-start gap-[4px] text-xs text-primary-50">
                                  <img
